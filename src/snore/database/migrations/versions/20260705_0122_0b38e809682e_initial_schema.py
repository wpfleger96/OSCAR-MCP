...
Revision ID: 0b38e809682e
Revises:
Create Date: 2026-07-05 01:22:23.487424
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("settings", ValidatedJSONWithDefault(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("data_quality_notes", ValidatedJSONWithDefault(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "programmatic_result_json", ValidatedJSONWithDefault(), nullable=False
        ),
        sa.Column("processing_time_ms", sa.Integer(), nullable=True),
        sa.Column("engine_versions_json", ValidatedJSONWithDefault(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("metrics_json", ValidatedJSONWithDefault(), nullable=False),
