...
type TotpConfirmResponse = components['schemas']['TotpConfirmResponse']
...
type TotpRegenerateResponse = components['schemas']['TotpRegenerateResponse']
...
export const confirmTotp = apiPost<TotpConfirmResponse, [body: TotpConfirmRequest]>(
...
export const adminResetTotp = apiPost<MessageResponse, [userId: number]>(
