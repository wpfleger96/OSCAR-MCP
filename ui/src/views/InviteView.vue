    ...
    <div class="login-page">
        <div class="login-card">
            ...
            <template v-else-if="lookupState === 'invalid'">
                <p class="invite-error">This invite link is invalid or has expired.</p>
            </template>
            ...
            <template v-else-if="lookupState === 'valid'">
                ...
                <a :href="`/api/v1/auth/invites/${token}/google`" class="google-btn">
...
import { lookupInvite, redeemInvite } from '@/api/auth'
...
async function handleRedeem() {
    ...
    try {
        await redeemInvite({ token, password: password.value })
        await fetchStatus()
